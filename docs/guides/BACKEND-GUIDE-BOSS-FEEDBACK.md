...
After backend implements the above, the frontend can be updated where needed (e.g. bank + state display, guarantor dropdown, and permanent debt / modifications UI).
